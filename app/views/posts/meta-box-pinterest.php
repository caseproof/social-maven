...
<label for="<?php echo $soma_post_options->pinterest_image_str; ?>">
  <input type="text" id="<?php echo $soma_post_options->pinterest_image_str; ?>" name="<?php echo $soma_post_options->pinterest_image_str; ?>" value="<?php echo esc_url( $soma_post_options->pinterest_image ); ?>" />
