...
<label for="<?php echo $soma_post_options->pinterest_image_str; ?>">
  ...
  <input type="button" id="pinterest-image-upload" class="soma-upload-button button-primary" value="<?php _e('Choose...');?>" />
  <span class="description"><?php _e('Select an image that will be used on Pinterest when pinning this post.'); ?></span>
</label>
